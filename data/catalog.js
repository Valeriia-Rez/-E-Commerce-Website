window.catalog = [{
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/photo9.jpg',
    preview: ['img/photo9.jpg', 'img/photo9.jpg', 'img/photo9.jpg']
}, {
    ...
    colors: ['Black', 'White'],
    sizes: ['UK 18'],
    thumbnail: 'img/photo7.jpg',
    preview: ['img/photo7.jpg', 'img/photo7.jpg', 'img/photo7.jpg']
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/photo13.jpg',
    preview: ['img/photo13.jpg', 'img/photo13.jpg', 'img/photo13.jpg']
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'img/photo14.jpg',
    preview: ['img/photo14.jpg', 'img/photo14.jpg', 'img/photo14.jpg']
}, {
    ...
    preview: ['img/photo3.jpg', 'img/photo3.jpg', 'img/photo3.jpg']
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/photo_6.jpg',
    preview: ['img/photo_6.jpg', 'img/photo_6.jpg', 'img/photo_6.jpg']
}, {
    ...
    colors: ['Green'],
    sizes: ['UK 19'],
    thumbnail: 'img/photo5.jpg',
    preview: ['img/photo5.jpg', 'img/photo5.jpg', 'img/photo5.jpg']
}, {
    ...
    preview: ['img/photo2.jpg', 'img/photo2.jpg', 'img/photo2.jpg']
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/photo6.jpg',
    preview: ['img/photo6.jpg', 'img/photo6.jpg', 'img/photo6.jpg']
}, {
    ...
    colors: ['Dark Blue'],
    sizes: ['UK 19'],
    thumbnail: 'img/photo12.jpg',
    preview: ['img/photo12.jpg', 'img/photo12.jpg', 'img/photo12.jpg']
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/photo8.jpg',
    preview: ['img/photo8.jpg', 'img/photo8.jpg', 'img/photo8.jpg']
}, {
    ...
    sizes: ['UK 18', 'UK 19'],
    thumbnail: 'img/photo11.jpg',
    preview: ['img/photo11.jpg', 'img/photo11.jpg', 'img/photo11.jpg']
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'img/photo10.jpg',
    preview: ['img/photo10.jpg', 'img/photo10.jpg', 'img/photo10.jpg']
}];